...
| No. | Procédure          |
| :---------------: |:---------------| 
| 1 | Traversez le cimetière | 
| 2 | Suivez le chemin et récupérez le coupe-boulon |   
| 3 | Après la cinématique, rebroussez chemin jusqu'à la porte en bas des escaliers <br> Ouvrez la avec le coupe-boulon |   
| 4 | Récupérez tous les objets dans la salle des gardes  |   
...
| 8 | Montez dans le couloir Est, via l'escalier de secours |   
| 9 | Traversez jusqu'à la salle d'art |   
| 10 | Prenez seulement la carte pour le dépôt d'armes |
...
| No. | Lieu          | Objets |
| :---------------: |:---------------| :------------- |
| 1 | Cimetière | Ruban encreur (sur le banc, au fond à gauche) |
...
| 9 | Couloir Est, 2ème étage | Planches en bois (à côté du mur dans le coin nord-ouest du passage) |
...
???+ danger "12. Éliminez les deux zombies enflammés"
    ...
    ![Image title](IMG/L1.jpg){ width="416" }
...
???+ warning "16. Attention en sortant de la salle de presse"
    ...
    ![Image title](IMG/L2.jpg){ width="416" }
